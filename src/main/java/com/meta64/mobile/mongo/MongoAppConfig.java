...
/* 
 * todo-1: there are two places i'm specifying basePackages here. Are both required ?
 */
...
public class MongoAppConfig extends AbstractMongoConfiguration {
	...
	private MongoClient getMongoClient() {
		// Mongo Client
		if (mongoClient == null) {
			// todo-1: to make credentials work we need to CREATE the user, after first checking to
