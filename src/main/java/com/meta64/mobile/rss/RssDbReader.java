...
//	}
//
//	public void addToMap(HashMap<String, Integer> map, NodeEntity node, String category) throws Exception {
//
//		int id = node.getId();
//
...
//				//ALog.log("map " + category + " identifier text [" + entityText.getValue() + "] to id " + id);
//			}
