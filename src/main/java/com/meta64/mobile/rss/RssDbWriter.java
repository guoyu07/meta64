...
public class RssDbWriter {
	...
	// */
	// public void write(Session session, Node feedNode, final FeedNodeInfo feedNodeInfo, final
	// SyndEntry entry) {
	//
	// try {
	...
	// // */
	// // private static void processEntryImages(SyndEntry entry, RssFeedWrapper wFeed,
	// StringBuilder
