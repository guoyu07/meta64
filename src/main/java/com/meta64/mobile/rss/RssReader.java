...
public class RssReader {
	...
	//
	// private static final String FAKE_USER_AGENT = "Mozilla/5.0 (X11; Linux x86_64)
	...
	//
	// /*
	// * todo-3: there is no finally block in this method. will be memory leak. Currently this
	// method
	// * isn't being used so i'm not worrying about it for now.
	// */
	// public void readUrl__unused(String url) {
	// if (true) throw ExUtil.newEx("don't call this until you fix missing finally block memory
	// leak.");
	...
	//
	// log.debug("RawRead of " + url + " -> Response Code : " +
	...
	// * figured out why, but in the process of researching it I decided using Apache HttpClient
	// could
	// * be better anyway, and by the time I got HttpClient in place it started working on all
	// Feeds,
