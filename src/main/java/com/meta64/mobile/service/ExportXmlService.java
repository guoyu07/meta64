...
public class ExportXmlService {
	...
	//
	// /*
	// * Exports the node specified in the req. If the node specified is "/", or the repository
	// root,
	...
	// }
	//
	// private void exportNodeToXMLFile(Session session, String nodeId, ExportXMLViewType
	// formatType, boolean includeBinaries) {
	//
