...
public class ExportZipService {
	...
	//
	// /*
	// * NOTE: It's correct that there's no finally block in here enforcing the closeEntry, becasue
	// we
	...
	// addFileEntry(parentFolder + "/" + fileName + "/" + fileName + ".txt",
	...
	//
	// /*
	// * Adds prop to allProps, unless it's sent back in contentText because content property will
	// be
	// * written to a separate file.
	// */
	// private void processProperty(Property prop, List<ExportPropertyInfo> allProps,
	// ValContainer<String> contentText, ValContainer<Property> binDataProp,
