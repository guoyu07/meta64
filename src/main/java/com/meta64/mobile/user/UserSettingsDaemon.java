...
public class UserSettingsDaemon {
	...
	//
	// /*
	// * I had this running every 20 seconds, and I think it is leaking memory and bringing the
	// server
	...
	// }
	//
	// private void saveSettingsForUser(Session session, String userName, UnsavedUserSettings
	// settings) {
	// try {
	...
	// return;
	// }
	// log.trace("Settings change: userName=" + userName + " prop: " + propertyName + "=" +
	// propertyVal);
	//
