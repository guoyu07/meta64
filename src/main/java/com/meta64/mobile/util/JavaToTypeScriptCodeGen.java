...
public class JavaToTypeScriptCodeGen {
	...
	/*
	 * The commented code below DOES work, and will generate the TypeScript, however the TypeScript
	 * it generates doesn't prefix the 'interface' definitions with 'export', and also doesn't have
	...
	public static void main(String[] args) {
		try {
			...
			Input input = Input.fromClassNamesAndJaxrsApplication(null, classNamePatterns, null, false, null, new JavaToTypeScriptCodeGen().getClass().getClassLoader());
			Output output = Output.to(new File("/home/clay/ferguson/meta64Oak/src/main/resources/public/ts/json-models.ts"));
