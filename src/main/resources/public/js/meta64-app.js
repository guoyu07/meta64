...
(function (m64) {
    ...
    (function (edit) {
        ...
        var deleteNodesResponse = function (res) {
        ...
        var splitContentResponse = function (res) {
...
(function (m64) {
    ...
    (function (props_1) {
        ...
        props_1.renderProperties = function (properties) {
            if (properties) {
                var ret_1 = "<table border=1 class='property-table'>";
                var propCount_1 = 0;
                $.each(properties, function (i, property) {
                    if (m64.render.allowPropertyToDisplay(property.name)) {
                        var isBinaryProp = m64.render.isBinaryProperty(property.name);
                        propCount_1++;
                        ret_1 += "<tr class='prop-table-row'>";
                        ret_1 += "<td class='prop-table-name-col'>" + m64.render.sanitizePropertyName(property.name)
                            + "</td>";
                        if (isBinaryProp) {
                            ret_1 += "<td class='prop-table-val-col'>[binary]</td>";
                        }
                        else if (!property.values) {
                            var val = property.htmlValue ? property.htmlValue : property.value;
                            ret_1 += "<td class='prop-table-val-col'>" + m64.render.wrapHtml(val) + "</td>";
                        }
                        else {
                            ret_1 += "<td class='prop-table-val-col'>" + props.renderPropertyValues(property.values)
                                + "</td>";
                        }
                        ret_1 += "</tr>";
                    }
...
(function (m64) {
    ...
    (function (menuPanel) {
        ...
        menuPanel.build = function () {
            var editMenuItems = menuItem("Move", "moveSelNodesButton", "m64.edit.moveSelNodes();") +
            ...
            var searchMenuItems = menuItem("Text Search", "searchDlgButton", "(new m64.SearchDlg()).open();") +
