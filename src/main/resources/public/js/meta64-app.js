...
(function (m64) {
    ...
    (function (view) {
        ...
        view.refreshTreeResponse = function (res, targetId, renderParentIfLeaf, highlightId) {
            m64.render.renderPageFromData(res);
            if (highlightId) {
                m64.meta64.highlightRowById(highlightId, true);
            }
            else {
                if (targetId) {
        ...
        view.refreshTree = function (nodeId, renderParentIfLeaf, highlightId, isInitialRender) {
            ...
            m64.util.json("renderNode", {
                ...
                view.refreshTreeResponse(res, nodeId, renderParentIfLeaf, highlightId);
