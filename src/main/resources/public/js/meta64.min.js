...
view.refreshTree(null,!1),meta64.jqueryChangePage("#mainPage"),view.scrollToSelectedNode())},g=function(a){console.log("insertBookResponse running.");util.checkSuccess("Insert Book",a);view.refreshTree(null,!1);meta64.jqueryChangePage("#mainPage");view.scrollToSelectedNode()},h=function(a){util.checkSuccess("Delete node",a)&&(meta64.clearSelectedNodes(),view.refreshTree(null,!1))},l=function(a){util.checkSuccess("Editing node",a)&&(k.editNode=a.nodeInfo,meta64.changePage(editNodePg))},m=function(a){util.checkSuccess("Move nodes",
...
saveNewNode:function(a){a||(a=util.getRequiredElement("#newNodeNameId").val());meta64.userName!=c.createdBy&&"admin"!=c.createdBy&&(b=!0);meta64.treeDirty=!0;k.nodeInsertTarget?util.json("insertNode",{parentId:c.id,targetName:k.nodeInsertTarget.name,newNodeName:a},p):util.json("createSubNode",{nodeId:c.id,newNodeName:a},r)},saveExistingNode:function(){for(var d=[],e=0,c=0;;){var f="editNodeTextContent"+e;if(meta64.fieldIdToPropMap.hasOwnProperty(f)){var h=meta64.fieldIdToPropMap[f],f=$("#"+f).val();
f!==h.value&&(d.push({name:h.name,value:f}),c++)}else break;e++}0<c?(util.json("saveNode",{nodeId:k.editNode.id,properties:d,sendNotification:b},a),b=!1):alert("You didn't change any information!")},moveNodeUp:function(a){var b=meta64.uidToNodeMap[a];b?(a=meta64.getOrdinalOfNode(b),console.log("ordinal="+a),-1==a&&0>=a||util.json("setNodePosition",{parentNodeId:meta64.currentNodeId,nodeId:b.name,siblingId:meta64.currentNodeData.children[a-1].name},n)):console.log("idToNodeMap does not contain "+a)},
...
importNodes:function(){var a=meta64.getHighlightedNode(),b=util.getRequiredElement("#importTargetNodeName").val();util.emptyString(b)?alert("Please enter a name for the import file."):a&&util.json("import",{nodeId:a.id,sourceFileName:b},f)},runEditNode:function(a){var b=meta64.uidToNodeMap[a];b?(k.editingUnsavedNode=!1,util.json("initNodeEdit",{nodeId:b.id},l)):(k.editNode=null,alert("Unknown nodeId in editNodeClick: "+a))},populateEditNodePg:function(){view.initEditPathDisplayById("#editNodePathDisplay");
var a="",b=0;meta64.fieldIdToPropMap={};if(k.editNode)$.each(k.editNode.properties,function(d,e){if(render.allowPropertyToDisplay(e.name)){var c="editNodeTextContent"+b;meta64.fieldIdToPropMap[c]=e;var f=e.values&&0<e.values.length,h=render.isReadOnlyProperty(e.name),g=render.isBinaryProperty(e.name);if(h||g)c="RdOnly_"+c;var l="";if(!h&&!g){var l=render.makeTag("a",{onClick:"props.clearProperty('"+c+"');","class":"ui-btn ui-btn-inline ui-icon-back ui-btn-icon-left"},"Clear"),k="",m="";e.name!==jcrCnst.CONTENT&&
(m=render.makeTag("a",{onClick:"props.deleteProperty('"+e.name+"');","class":"ui-btn ui-btn-inline ui-icon-delete ui-btn-icon-left"},"Del"),k=render.makeTag("a",{onClick:"props.addSubProperty('"+c+"');","class":"ui-btn ui-btn-inline ui-icon-star ui-btn-icon-left"},"Add Multi"));l=k+l+m;l=0<l.length?render.makeHorizontalFieldSet(l,"property-edit-button-bar"):""}f?(console.log("Property multi-type: name="+e.name+" count="+e.values.length),l+=props.makeMultiPropEditor(c,e,h,g)):(console.log("Property single-type: "+
e.name),l+=render.makeTag("label",{"for":c},render.sanitizePropertyName(e.name)),f=g?"[binary]":e.value,l=h||g?l+render.makeTag("textarea",{id:c,readonly:"readonly",disabled:"disabled"},f?f:""):l+render.makeTag("textarea",{id:c},f?f:""));a+=render.makeTag("div",{"class":"ui-field-contain property-edit-field"},l);b++}else console.log("Hiding property: "+e.name)});else var d=render.makeTag("label",{"for":"newNodeNameId"},"New Node Name")+render.makeTag("textarea",{id:"newNodeNameId"},""),a=a+render.makeTag("div",
{"class":"ui-field-contain property-edit-field"},d);util.setHtmlEnhanced($("#propertyEditFieldContainer"),a);d=k.editingUnsavedNode?"You may leave this field blank and a unique ID will be assigned. You only need to provide a name if you want this node to have a more meaningful URL.":"";$("#editNodeInstructions").html(d);util.setVisibility("#addPropertyButton",!k.editingUnsavedNode);d=k.editNode&&k.editNode.id&&!k.editNode.id.startsWith("/");util.setVisibility("#makeNodeReferencableButton",k.editNode&&
!d&&!k.editingUnsavedNode)},insertNode:function(a){if(c=meta64.currentNode){var b=null;if(b=a?meta64.uidToNodeMap[a]:meta64.getHighlightedNode())k.nodeInsertTarget=b,k.startEditingNewNode()}else console.log("Unknown parent")},createSubNodeUnderHighlight:function(){(c=meta64.getHighlightedNode())?(k.nodeInsertTarget=null,k.startEditingNewNode()):alert("Tap a node to insert under.")},replyToComment:function(a){k.createSubNode(a)},createSubNode:function(a){if(a){if(c=meta64.uidToNodeMap[a],!c){console.log("Unknown nodeId in createSubNode: "+
a);return}}else c=meta64.currentNode;k.nodeInsertTarget=null;k.startEditingNewNode()},clearSelections:function(){meta64.clearSelectedNodes();render.renderPageFromData();meta64.jqueryChangePage("#mainPage")},deleteSelNodes:function(){var a=meta64.getSelectedNodeIdsArray();a&&0!=a.length?confirmPg.areYouSure("Confirm Delete","Delete "+a.length+" node(s) ?","Yes, delete.",function(){util.json("deleteNodes",{nodeIds:a},h)}):alert("You have not selected any nodes. Select nodes to delete first.")},moveSelNodes:function(){var a=
...
jcrCnst.BIN_VER,jcrCnst.BIN_DATA,jcrCnst.BIN_MIME,jcrCnst.COMMENT_BY,jcrCnst.PUBLIC_APPEND]);util.addAll(b.readOnlyPropertyList,[jcrCnst.UUID,jcrCnst.MIXIN_TYPES,jcrCnst.CREATED,jcrCnst.CREATED_BY,jcrCnst.LAST_MODIFIED,jcrCnst.LAST_MODIFIED_BY,jcrCnst.IMG_WIDTH,jcrCnst.IMG_HEIGHT,jcrCnst.BIN_VER,jcrCnst.BIN_DATA,jcrCnst.BIN_MIME,jcrCnst.COMMENT_BY,jcrCnst.PUBLIC_APPEND]);util.addAll(b.binaryPropertyList,[jcrCnst.BIN_DATA])},initApp:function(){c||(console.log("initApp running."),c=!0,b.initConstants(),
b.displaySignupMessage(),$(window).on("orientationchange",b.orientationHandler),$(window).bind("beforeunload",function(){return"Leave Meta64 ?"}),b.addClickListeners(),b.deviceWidth=$(window).width(),b.deviceHeight=$(window).height(),user.refreshLogin(),setInterval(function(){var a=$(window).width();a!=b.deviceWidth&&(b.deviceWidth=a,b.deviceHeight=$(window).height(),b.screenSizeChange())},1500),b.refreshAllGuiEnablement())},displaySignupMessage:function(){"ok"===$("#signupCodeResponse").text()&&
alert("Signup complete. You may now login.")},screenSizeChange:function(){b.currentNodeData&&(meta64.currentNode.imgId&&render.adjustImageSize(meta64.currentNode),$.each(b.currentNodeData.children,function(a,b){b.imgId&&render.adjustImageSize(b)}))},orientationHandler:function(a){},loadAnonPageHome:function(a){util.json("anonPageLoad",{ignoreUrl:a},b.anonPageLoadResponse)}};console.log("Module ready: meta64.js");return b}();console.log("running module: nav.js");
var nav=function(){var c={displayingHome:function(){return meta64.isAnonUser?meta64.currentNodeId===meta64.anonUserLandingPageNode:meta64.currentNodeId===meta64.homeNodeId},parentVisibleToUser:function(){return!c.displayingHome()},showSearchPage:function(){meta64.changePage(searchResultsPg)},upLevelResponse:function(b,a){b&&b.node?(render.renderPageFromData(b),meta64.highlightRowById(a,!0),meta64.refreshAllGuiEnablement()):alert("No data is visible to you above this node.")},navUpLevel:function(){c.parentVisibleToUser()&&
util.json("renderNode",{nodeId:meta64.currentNodeId,upLevel:1}).done(function(b){c.upLevelResponse(b,meta64.currentNodeId)})},getSelectedDomElement:function(){var b=meta64.getHighlightedNode();return b&&(b=meta64.uidToNodeMap[b.uid])?util.domElm(b.uid+"_row"):null},clickOnNodeRow:function(b,a){var d=meta64.uidToNodeMap[a];d?(meta64.highlightNode(d,!1),meta64.editMode&&!d.owner&&(console.log("calling updateNodeInfo"),meta64.updateNodeInfo(d)),meta64.refreshAllGuiEnablement()):console.log("clickOnNodeRow recieved uid that doesn't map to any node. uid="+
a)},openNode:function(b){var a=meta64.uidToNodeMap[b];meta64.highlightNode(a,!0);a?view.refreshTree(a.id,!1):alert("Unknown nodeId in openNode: "+b)},toggleNodeSel:function(b){if(util.getRequiredElement()){var a=$("#"+b+"_sel"),d=a.attr("class").contains("ui-btn-b");d?(util.changeOrAddClass(a,"ui-btn-b","ui-btn-a"),d=!1):(util.changeOrAddClass(a,"ui-btn-a","ui-btn-b"),d=!0);d?meta64.selectedNodes[b]=!0:delete meta64.selectedNodes[b];a.enhanceWithin();view.updateStatusBar();meta64.refreshAllGuiEnablement()}else console.log("Unable to find Sel button for uid: "+
b)},navHomeResponse:function(b){meta64.clearSelectedNodes();render.renderPageFromData(b);util.scrollToTop();meta64.refreshAllGuiEnablement()},navHome:function(){meta64.isAnonUser?meta64.loadAnonPageHome(!0):util.json("renderNode",{nodeId:meta64.homeNodeId},c.navHomeResponse)}};console.log("Module ready: nav.js");return c}();console.log("running module: changePasswordPg.js");
...
var confirmPg=function(){var c,b,a,d,e={domId:"confirmPg",areYouSure:function(e,g,h,l){c=e;b=g;a=h;d=l;meta64.openDialog(confirmPg)},build:function(){var a;a="<h3 id='confirmPgTitle'></h3><p id='confirmPgMessage'></p>"+render.makeBackButton("Yes","confirmPgYesButton","b");a+=render.makeBackButton("No","confirmPgNoButton","a");a=render.makeTag("div",{"data-role":"content"},a);util.setHtmlEnhanced($("#confirmPg"),a);$("#confirmPgYesButton").on("click",e.runCallback)},runCallback:function(){d&&d()},
init:function(){$("#confirmPgTitle").text(c);$("#confirmPgMessage").text(b);$("#confirmPgYesButton").text(a)}};console.log("Module ready: confirmPg.js");return e}();console.log("running module: editNodePg.js");
...
var messagePg=function(){var c,b,a,d={domId:"messagePg",showMessage:function(d,f,g){c=d;b=f;a=g;meta64.openDialog(messagePg)},build:function(){var a;a="<h3 id='messagePgTitle'></h3><p id='messagePgMessage'></p>"+render.makeBackButton("Ok","messagePgOkButton","b");a=render.makeTag("div",{"data-role":"content"},a);util.setHtmlEnhanced($("#messagePg"),a);$("#messagePgOkButton").on("click",d.runCallback)},runCallback:function(){a&&a()},init:function(){$("#messagePgTitle").text(c);$("#messagePgMessage").html(b)}};
console.log("Module ready: messagePg.js");return d}();console.log("running module: popupMenuPg.js");
...
a)}var a={domId:"popupMenuPg",build:function(){var a=b("Change Password","changePasswordPgButton","user.changePasswordPg();")+b("Preferences","accountPreferencesPgButton","prefs.accountPreferencesPg();")+b("Insert Book: War and Peace","insertBookWarAndPeaceButton"," edit.insertBookWarAndPeace();")+b("Full Repository Export","fullRepositoryExport"," edit.fullRepositoryExport();")+b("Donate","donatePgButton","meta64.openDonatePg();"),a=c("My Account",a),e=b("Attachments","manageAttachmentsButton","attachment.openUploadPg();")+
b("Sharing","editNodeSharingButton","share.editNodeSharing();")+b("Move","moveSelNodesButton","edit.moveSelNodes();")+b("Finish Moving","finishMovingSelNodesButton","edit.finishMovingSelNodes();")+b("Rename","renameNodePgButton","edit.openRenameNodePg();")+b("Delete","deleteSelNodesButton","edit.deleteSelNodes();")+b("Clear Selections","clearSelectionsButton","edit.clearSelections();")+b("Import","openImportPgButton","edit.openImportPg();")+b("Export","openExportPgButton","edit.openExportPg();"),
e=c("Edit",e),f=b("Toggle Properties","propsToggleButton","props.propsToggle();")+b("Refresh","refreshPageButton","view.refreshPage();")+b("Show URL","showFullNodeUrlButton","render.showNodeUrl();"),f=c("View Options",f),a=render.makeTag("div",{style:"margin: 0; min-width: 300px; position: fixed; top: 2em; left: 2em;","data-role":"collapsible-set"},a+e+f);util.setHtmlEnhanced($("#popupMenuPg"),a)},init:function(){var b=util.getPropertyCount(meta64.selectedNodes),c=meta64.getHighlightedNode(),f=!util.nullOrUndef(edit.nodesToMove)&&
!a.isAnonUser;util.setEnablement($("#changePasswordPgButton"),!meta64.isAnonUser);util.setEnablement($("#accountPreferencesPgButton"),!meta64.isAnonUser);util.setEnablement($("#insertBookWarAndPeaceButton"),meta64.isAdminUser&&null!=c,meta64.isAdminUser);util.setEnablement($("#fullRepositoryExport"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#donatePgButton"),!0);util.setEnablement($("#manageAttachmentsButton"),null!=c&&!meta64.isAnonUser);util.setEnablement($("#editNodeSharingButton"),
null!=c&&!meta64.isAnonUser);util.setEnablement($("#moveSelNodesButton"),null!=c&&!meta64.isAnonUser);util.setEnablement($("#renameNodePgButton"),null!=c&&!meta64.isAnonUser);util.setEnablement($("#finishMovingSelNodesButton"),f,f);util.setEnablement($("#openExportPgButton"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#openImportPgButton"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#deleteSelNodesButton"),b)}};console.log("Module ready: popupMenuPg.js");return a}();console.log("running module: prefsPg.js");
...
edit.editNode.properties.length;b++)if(a===edit.editNode.properties[b].name){edit.editNode.properties.splice(b,1);break}},makeMultiPropEditor:function(a,b,c,f){var g="",h=b.values;h&&0!=h.length||(h=[],h.push(""));for(var l=0;l<h.length;l++){console.log("prop multi-val["+l+"]="+h[l]);var m=a+"_subProp"+l,g=g+render.makeTag("label",{"for":m},(0==l?b.name:"*")+"."+l),n=f?"[binary]":h[l],g=f||c?g+render.makeTag("textarea",{id:m,readonly:"readonly",disabled:"disabled"},n?n:""):g+render.makeTag("textarea",
{id:m},n?n:"")}return g},setPreferredPropertyOrder:function(a){if(a){var b=[];$.each(a,function(a,c){c.name===jcrCnst.CONTENT?b.unshift(c):b.push(c)});return b}},renderProperties:function(a){if(a){var b="<table data-role='table' class='prop-table ui-responsive ui-shadow table-stripe property-text'>",c=0,b=b+"<thead><tr><th></th><th></th></tr></thead>",b=b+"<tbody>";$.each(a,function(a,g){if(render.allowPropertyToDisplay(g.name)){var h=render.isBinaryProperty(g.name);c++;b+="<tr class='prop-table-row'>";
b+="<td class='prop-table-name-col'>"+render.sanitizePropertyName(g.name)+"</td>";b=h?b+"<td class='prop-table-val-col'>[binary]</td>":g.values?b+("<td class='prop-table-val-col'>"+props.renderPropertyValues(g.values)+"</td>"):b+("<td class='prop-table-val-col'>"+render.wrapHtml(g.htmlValue)+"</td>");b+="</tr>"}else console.log("Hiding property: "+g.name)});return 0==c?"":b+="</tbody></table>"}},getNodeProperty:function(a,b){if(!b||!b.properties)return null;for(var c=0;c<b.properties.length;c++){var f=
...
var render=function(){var c={buildPage:function(b){b.built||(b.build(),b.built=!0);b.init&&b.init()},renderNodeContent:function(b,a,d,e){var f="",g;g=""+c.getTopRightImageTag(b);var h=props.getNodePropertyVal(jcrCnst.COMMENT_BY,b);if(a&&meta64.editMode){f+="<div class='path-display'>Path: "+c.formatPath(b)+"</div>";f+="<div>";if(h)var l=h===meta64.userName?"created-by-me":"created-by-other",f=f+("<span class='"+l+"'>Comment By: "+h+"</span>");else b.createdBy&&(l=b.createdBy===meta64.userName?"created-by-me":
"created-by-other",f+="<span class='"+l+"'>Created By: "+b.createdBy+"</span>");f+="<span id='ownerDisplay"+b.uid+"'></span>";b.lastModified&&(f+="  Modified: "+b.lastModified);f+="</div>"}d&&!a&&b.name&&(f+="Name: "+b.name+" [uid="+b.uid+"]");f&&(g+=c.makeTag("div",{"class":"header-text"},f));if(meta64.showProperties)(a=props.renderProperties(b.properties))&&(g+=a);else if(a=props.getNodeProperty(jcrCnst.CONTENT,b))a=props.renderProperty(a),0<a.length&&(g+=c.makeTag("div",{"class":"jcr-content"},
c.wrapHtml(a)));e&&b.hasBinary&&(b.binaryIsImage?e=c.makeImageTag(b):(e=c.makeTag("a",{href:c.getUrlForNodeAttachment(b)},"[Download Attachment]"),e=c.makeTag("div",{"class":"binary-link"},e)),g=g.contains(cnst.INSERT_ATTACHMENT)?g.replaceAll(cnst.INSERT_ATTACHMENT,e):g+e);h&&h!=meta64.userName?(b=c.makeTag("a",{onClick:"edit.replyToComment('"+b.uid+"');","class":"ui-btn ui-btn-b ui-btn-inline ui-icon-plus ui-mini ui-btn-icon-comment"},"Reply"),g+=b):props.getNodePropertyVal(jcrCnst.PUBLIC_APPEND,
b)&&h!=meta64.userName&&(b=c.makeTag("a",{onClick:"edit.replyToComment('"+b.uid+"');","class":"ui-btn ui-btn-b ui-btn-inline ui-icon-plus ui-mini ui-btn-icon-comment"},"Add Comment"),g+=b);return g},renderNodeAsListItem:function(b,a,d,e){var f=b.uid,g=b.id===meta64.newChildNodeId;e=0<a&&1<e;a=a<d-1;d=b.name.startsWith("rep:")||meta64.currentNodeData.node.path.contains("/rep:");d=meta64.isAdminUser||!d;var h=meta64.getHighlightedNode();!g&&h&&h.uid===f&&(g=!0);e=c.makeRowButtonBarHtml(f,e,a,d);a=c.getNodeBkgImageStyle(b);
return c.makeTag("div",{"class":"node-table-row"+(g?" active-row":" inactive-row"),onClick:"nav.clickOnNodeRow(this, '"+f+"');",id:f+"_row",style:a},e+c.makeTag("div",{id:f+"_content"},c.renderNodeContent(b,!0,!0,!0)))},showNodeUrl:function(){var b=meta64.getHighlightedNode();if(b){var a=window.location.origin+"?id="+b.path;meta64.jqueryChangePage("#mainPage");a="URL using path: <br>"+a;(b=props.getNodePropertyVal("jcr:uuid",b))&&(a+="<p>URL for UUID: <br>"+window.location.origin+"?id="+b);messagePg.showMessage("URL of Node",
a)}else alert("You must first click on a node.")},getTopRightImageTag:function(b){b=props.getNodePropertyVal("img.top.right",b);var a="";b&&(a=c.makeTag("img",{src:b,"class":"top-right-image"},"",!1));return a},getNodeBkgImageStyle:function(b){b=props.getNodePropertyVal("img.node.bkg",b);var a="";b&&(a="background-image: url("+b+");");return a},makeRowButtonBarHtml:function(b,a,d,e){var f=selButton=createSubNodeButton=editNodeButton=moveNodeUpButton=moveNodeDownButton=insertNodeButton="";c.nodeHasChildren(b)&&
(f=c.makeTag("a",{onClick:"nav.openNode('"+b+"');","class":"ui-btn ui-btn-b ui-btn-inline ui-icon-plus ui-mini ui-btn-icon-left"},"Open"));meta64.editMode&&(selButton=c.makeTag("a",{id:b+"_sel",onClick:"nav.toggleNodeSel('"+b+"');","class":"ui-btn ui-btn-inline ui-icon-check ui-mini ui-btn-icon-left "+(meta64.selectedNodes[b]?"ui-btn-b":"ui-btn-a")},"Sel"),cnst.NEW_ON_TOOLBAR&&(createSubNodeButton=c.makeTag("a",{onClick:"edit.createSubNode('"+b+"');","class":"ui-btn ui-btn-inline ui-icon-star ui-mini ui-btn-icon-left"},
"New")),cnst.INS_ON_TOOLBAR&&(insertNodeButton=c.makeTag("a",{onClick:"edit.insertNode('"+b+"');","class":"ui-btn ui-btn-inline ui-icon-bars ui-mini ui-btn-icon-left"},"Ins")));meta64.editMode&&e&&(editNodeButton=c.makeTag("a",{onClick:"edit.runEditNode('"+b+"');","class":"ui-btn ui-btn-inline ui-icon-edit ui-mini ui-btn-icon-left"},"Edit"),meta64.currentNode.childrenOrdered&&(a&&(moveNodeUpButton=c.makeTag("a",{onClick:"edit.moveNodeUp('"+b+"');","class":"ui-btn ui-btn-inline ui-icon-arrow-u ui-mini ui-btn-icon-left"},
"Up")),d&&(moveNodeDownButton=c.makeTag("a",{onClick:"edit.moveNodeDown('"+b+"');","class":"ui-btn ui-btn-inline ui-icon-arrow-d ui-mini ui-btn-icon-left"},"Dn"))));b=selButton+f+insertNodeButton+createSubNodeButton+editNodeButton+moveNodeUpButton+moveNodeDownButton;return 0<b.length?c.makeHorizontalFieldSet(b,"compact-field-contain"):""},makeHorizontalFieldSet:function(b,a){var d=c.makeTag("fieldset",{"data-role":"controlgroup","data-type":"horizontal"},b);return c.makeTag("div",{"class":"ui-field-contain"+
...
if(b&&b.node){util.setVisibility("#listView",!0);c.renderMainPageControls();meta64.treeDirty=!1;a&&(meta64.uidToNodeMap={},meta64.idToNodeMap={},meta64.selectedNodes={},meta64.initNode(b.node),meta64.setCurrentNodeData(b));var d="",e=c.getNodeBkgImageStyle(b.node),f=c.renderNodeContent(b.node,!0,!0,!0);if(0<f.length){var g=b.node.uid,h=g+"_row",l="";meta64.editMode&&"/"!=b.node.path&&(l=c.makeTag("a",{onClick:"edit.runEditNode('"+g+"');","class":"ui-btn ui-btn-inline ui-icon-edit ui-mini ui-btn-icon-left"},
"Edit"),l=c.makeHorizontalFieldSet(l,"compact-field-contain page-top-button-bar"));e=c.makeTag("div",{"class":"node-table-row page-parent-node inactive-row",onClick:"nav.clickOnNodeRow(this, '"+g+"');",id:h,style:e},l+f);$("#mainNodeContent").show();$("#mainNodeContent").html(e)}else $("#mainNodeContent").hide();$("#mainNodeContent").trigger("updatelayout");view.updateStatusBar();c.renderMainPageControls();if(b.children){var m=b.children.length,n=0;$.each(b.children,function(b,e){var h=c.generateRow(b,
e,a,m,n);0!=h.length&&(d+=h,n++)})}0!=d.length||meta64.isAnonUser||(d=c.makeTag("a",{onClick:"edit.createSubNode();","class":"ui-btn ui-btn-inline ui-icon-star ui-btn-icon-left"},"Create Content"));util.setHtmlEnhancedById("#listView",d);meta64.screenSizeChange();meta64.getHighlightedNode()||util.scrollToTop()}else util.setVisibility("#listView",!1),$("#mainNodeContent").html("No default content is available.")},generateRow:function(b,a,d,e,f){if(meta64.isNodeBlackListed(a))return"";d&&meta64.initNode(a);
f++;return c.renderNodeAsListItem(a,b,e,f)},getUrlForNodeAttachment:function(b){return postTargetUrl+"bin/file-name?nodeId="+encodeURIComponent(b.path)+"&ver="+b.binVer},adjustImageSize:function(b){var a=$("#"+b.imgId);a&&b.width&&b.height&&(b.width>meta64.deviceWidth-80?(a.attr("width","100%"),a.attr("height","auto"),a.attr("style","max-width: "+maxWidth+"px;")):(a.attr("width",b.width),a.attr("height",b.height)))},makeImageTag:function(b){var a=c.getUrlForNodeAttachment(b);b.imgId="imgUid_"+b.uid;
if(b.width&&b.height){if(b.width>meta64.deviceWidth-50){var d=meta64.deviceWidth-50;return c.makeTag("img",{src:a,id:b.imgId,width:d+"px",height:d*b.height/b.width+"px"},null,!1)}return c.makeTag("img",{src:a,id:b.imgId,width:b.width+"px",height:b.height+"px"},null,!1)}return c.makeTag("img",{src:a,id:b.imgId},null,!1)},makeTag:function(b,a,d,c){"undefined"===typeof c&&(c=!0);var f="<"+b;a&&(f+=" ",$.each(a,function(a,b){f=b.contains("'")?f+(a+'="'+b+'" '):f+(a+"='"+b+"' ")}));return f=c?f+(">"+d+
"</"+b+">"):f+"/>"},makeEditField:function(b,a){return c.makeTag("label",{"for":a},b)+c.makeTag("input",{type:"text",name:a,id:a},"",!0)},makePasswordField:function(b,a){return c.makeTag("label",{"for":a},b)+c.makeTag("input",{type:"password",name:a,id:a},"",!0)},makeButton:function(b,a,d,c){d="ui-btn ui-btn-inline ui-btn-"+d;c&&(d+=" "+c);return render.makeTag("a",{id:a,"class":d},b)},makeBackButton:function(b,a,d){return render.makeTag("a",{id:a,"class":"ui-btn ui-icon-carat-l ui-btn-inline ui-btn-"+
d,"data-rel":"back"},b)},allowPropertyToDisplay:function(b){return null==meta64.simpleModePropertyBlackList[b]},isReadOnlyProperty:function(b){return meta64.readOnlyPropertyList[b]},isBinaryProperty:function(b){return meta64.binaryPropertyList[b]},sanitizePropertyName:function(b){return"simple"===meta64.editModeOption?b===jcrCnst.CONTENT?"Content":b:b}};console.log("Module ready: render.js");return c}();console.log("running module: search.js");
...
(a=b.searchResults);var d="",c=a.searchResults.length,f=0;$.each(a.searchResults,function(a,h){meta64.isNodeBlackListed(h)||(b.initSearchNode(h),f++,d+=b.renderSearchResultAsListItem(h,a,c,f))});util.setHtmlEnhanced($("#searchResultsView"),d)},renderSearchResultAsListItem:function(a,d,c,f){d=a.uid;a.name.startsWith("rep:")||meta64.currentNodeData.node.path.contains("/rep:");return render.makeTag("div",{"class":"node-table-row inactive-row",onClick:"srch.clickOnSearchResultRow(this, '"+d+"');",id:d+
...
{nodeId:d.sharingNode.path,includeAcl:!0,includeOwners:!0},c)},d={sharingNode:null,populateSharingPg:function(a){var c="<h2>Node Share Settings</h2>";$.each(a.aclEntries,function(a,d){c+="<h4>User: "+d.principalName+"</h4>";c+=render.makeTag("div",{"class":"privilege-list"},b(d.principalName,d))});c+=render.makeTag("input",{type:"checkbox",name:"allowPublicCommenting",id:"allowPublicCommenting"},"",!1);c+=render.makeTag("label",{"for":"allowPublicCommenting"},"Allow public commenting under this node.",
!0);util.setHtmlEnhanced($("#sharingListFieldContainer"),c);util.setCheckboxVal("#allowPublicCommenting",a.publicAppend);$("#allowPublicCommenting").bind("change",d.publicCommentingChanged)},publicCommentingChanged:function(){var a=$("#allowPublicCommenting").is(":checked");util.json("addPrivilege",{nodeId:d.sharingNode.id,publicAppend:a?"true":"false"},null)},removePrivilege:function(b,c){util.json("removePrivilege",{nodeId:d.sharingNode.id,principal:b,privilege:c},a)},shareNodeToPersonPg:function(){meta64.changePage(shareToPersonPg)},
shareNodeToPerson:function(){var a=$("#shareToUserName").val();a?util.json("addPrivilege",{nodeId:d.sharingNode.id,principal:a,privileges:["read","write","addChildren","nodeTypeManagement"]},d.reloadFromShareWithPerson):alert("Please enter a username")},shareNodeToPublic:function(){console.log("Sharing node to public.");util.json("addPrivilege",{nodeId:d.sharingNode.id,principal:"everyone",privileges:["read"]},d.reload)},editNodeSharing:function(){var a=meta64.getHighlightedNode();a?(d.sharingNode=
...
b){$.cookie(a,b,{expires:365,path:"/"})},populateLoginPgFromCookies:function(){var a=$.cookie(cnst.COOKIE_LOGIN_USR),b=$.cookie(cnst.COOKIE_LOGIN_PWD);a&&$("#userName").val(a);b&&$("#password").val(b)},openLoginPg:function(){meta64.isAnonUser?meta64.changePage(loginPg):g.logout(!0)},signup:function(){var a=util.getRequiredElement("#signupUserName").val(),b=util.getRequiredElement("#signupPassword").val(),d=util.getRequiredElement("#signupEmail").val(),c=util.getRequiredElement("#signupCaptcha").val();
util.anyEmpty(a,b,d,c)?alert("Sorry, you cannot leave any fields blank."):util.json("signup",{userName:a,password:b,email:d,captcha:c},f)},pageInitSignupPg:function(){user.tryAnotherCaptcha()},tryAnotherCaptcha:function(){var a=util.currentTimeMillis(),a=postTargetUrl+"captcha?t="+a;$("#captchaImage").attr("src",a)},refreshLogin:function(){console.log("refreshLogin.");var d,e,f=!1;if("true"===$("#loginSessionReady").text())console.log("    loginSessionReady = true"),e=d="",f=!0;else{console.log("    loginSessionReady = false");
if("0"===$.cookie(cnst.COOKIE_LOGIN_STATE)){meta64.loadAnonPageHome(!1);return}var g=$.cookie(cnst.COOKIE_LOGIN_USR),p=$.cookie(cnst.COOKIE_LOGIN_PWD),f=!util.emptyString(g)&&!util.emptyString(p);console.log("cookieUser="+g+" usingCookies = "+f);d=g?g:"";e=p?p:""}console.log("refreshLogin with name: "+d);g=util.json("login",{userName:d,password:e,tzOffset:(new Date).getTimezoneOffset(),dst:util.daylightSavingsTime});f?g.done(function(b){a(b,d,e,f)}):g.done(function(a){console.log("refreshLoginResponse");
b(a);c(a);meta64.loadAnonPageHome(!1)})},login:function(){var b=$.trim($("#userName").val()),d=$.trim($("#password").val());util.json("login",{userName:b,password:d,tzOffset:(new Date).getTimezoneOffset(),dst:util.daylightSavingsTime}).done(function(c){a(c,b,d)})},logout:function(a){meta64.isAnonUser||($(window).off("beforeunload"),a&&user.writeCookie(cnst.COOKIE_LOGIN_STATE,"0"),util.json("logout",{},d))},changePassword:function(){var a=util.getRequiredElement("#changePassword1").val(),b=util.getRequiredElement("#changePassword2").val();
...
this.indexOf(a)});"function"!=typeof String.prototype.replaceAll&&(String.prototype.replaceAll=function(a,b){return this.replace(new RegExp(a.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1"),"g"),b)});var c=0,b={daylightSavingsTime:(new Date).dst()?!0:!1,json:function(a,b,e){c++;a=$.ajax({url:postTargetUrl+a,contentType:"application/json",type:"post",dataType:"json",cache:!1,data:JSON.stringify(b)});a.done(function(a){"not-logged-in"===a.errorCodeName&&(alert("Oops. Session timed out."),$(window).off("beforeunload"),
window.location.href=window.location.origin);"function"==typeof e&&e(a)});a.fail(function(a,b){var d="Server request failed.\n\n";try{d+="Status: "+a.statusText+"\n",d+="Code: "+a.status+"\n"}catch(c){}alert(d)});a.complete(function(){c--});return a},ajaxReady:function(a){return 0<c?(console.log("Ignoring requests: "+a+". Ajax currently in progress."),!1):!0},isAjaxWaiting:function(){return 0<c},delayedFocus:function(a){setTimeout(function(){$(a).focus()},500)},checkSuccess:function(a,b){b.success||
alert(a+" failed: "+b.message);return b.success},addAll:function(a,b){for(var c=0;c<b.length;c++)b[c]?a[b[c]]=!0:console.error("null element in addAll at idx="+c)},nullOrUndef:function(a){return null===a||void 0===a},getUidForId:function(a,b){var c=a[b];c||(c=meta64.nextUid++,a[b]=c);return c},getPreviousPage:function(){var a="#"+$.mobile.activePage.prev('div[data-role="page"]')[0].id;alert("prevPage="+a);return a},domElm:function(a){if(a.contains("#"))return console.log("do not use # in domElm"),
null;var b=document.getElementById(a);b&&0!=b.length||console.log("domElm Error. Required element id not found: "+a);return b},getRequiredElement:function(a){var b=$(a);null==b&&console.log("getRequiredElement. Required element id not found: "+a);return b},setCheckboxVal:function(a,b){$(a).prop("checked",b).checkboxradio("refresh")},isObject:function(a){return a&&0!=a.length},currentTimeMillis:function(){return(new Date).getMilliseconds()},emptyString:function(a){return!a||0==a.length},setEnablement:function(a,
c,e){"undefined"===typeof e||e?b.setVisibility(a,!0):b.setVisibility(a,!1);c&&a.removeClass("ui-state-disabled");c||a.addClass("ui-state-disabled")},hookSliderChanges:function(){for(var a=0;a<arguments.length;a++){var b=arguments[a]+"SliderChange",c=window[b];"function"!==typeof c&&alert("Function not found: "+b);if(!hookSlider("#"+arguments[a]+"Slider",c)){alert("Failed to hook slider: "+arguments[a]);break}}},hookSlider:function(a,c){b.getRequiredElement(a).change(c);return!0},bindEnterKey:function(a,
c){b.bindKey(a,c,13)},bindKey:function(a,b,c){$(a).keypress(function(a){if(a.which==c)return b(),!1})},anyEmpty:function(){for(var a=0;a<arguments.length;a++){var b=arguments[a];if(!b||0==b.length)return!0}return!1},changeOrAddClass:function(a,b,c){a=$(a);a.toggleClass(b,!1);a.toggleClass(c,!0)},changeOrAddClass__mine:function(a,b,c){if(a.className&&0!=a.className.length){for(var f=a.className.split(" "),g="",h=!1,l=0;l<f.length;l++){var m=f[l];if(m===c){if(h)continue;h=!0}else if(m===b){if(h)continue;
m=c;h=!0}0<g.length&&(g+=" ");g+=m}h||(0<g.length&&(g+=" "),g+=c);a.className=g}else console.log("no existing className is available on element, so assigning to "+c),a.className=c},verifyType:function(a,b,c){return typeof a!==b?(alert(c),!1):!0},setHtmlEnhancedById:function(a,c){var e=b.getRequiredElement(a);e?($(e).html(c),$(e).enhanceWithin()):console.log("setting failed.")},setHtmlEnhanced:function(a,b){a.html(b);a.enhanceWithin()},getPropertyCount:function(a){var b=0,c;for(c in a)a.hasOwnProperty(c)&&
b++;return b},printObject:function(a){var b="";$.each(a,function(a,c){b+=a+" , "+c+"\n"});return b},printProperties:function(a){if(a){var b="";$.each(a,function(a,c){b+=a+"\n"});return b}console.error("printProperties recieved null.")},scrollToTop:function(){window.scrollTo(0,0)},printKeys:function(a){var b="";$.each(a,function(a,c){0<b.length&&(b+=",");b+=a});return b},setVisibility:function(a,b){b?$(a).show():$(a).hide();$(a).trigger("updatelayout")}};console.log("Module ready: util.js");return b}();console.log("running module: view.js");
