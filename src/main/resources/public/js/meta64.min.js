...
e=d("Edit",e),f=a("Toggle Properties","propsToggleButton","props.propsToggle();")+a("Refresh","refreshPageButton","view.refreshPage();")+a("Show URL","showFullNodeUrlButton","render.showNodeUrl();"),f=d("View Options",f),b=render.makeTag("div",{style:"margin: 0; min-width: 300px; position: fixed; top: 2em; left: 2em;","data-role":"collapsible-set"},b+e+f);util.setHtmlEnhanced($("#popupMenuPg"),b)},init:function(){var a=util.getPropertyCount(meta64.selectedNodes),e=meta64.getHighlightedNode(),f=!util.nullOrUndef(edit.nodesToMove)&&
!b.isAnonUser;util.setEnablement($("#changePasswordPgButton"),!meta64.isAnonUser);util.setEnablement($("#accountPreferencesPgButton"),!meta64.isAnonUser);util.setEnablement($("#insertBookWarAndPeaceButton"),meta64.isAdminUser&&null!=e,meta64.isAdminUser);util.setEnablement($("#fullRepositoryExport"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#donatePgButton"),!0);util.setEnablement($("#manageAttachmentsButton"),null!=e&&!meta64.isAnonUser);util.setEnablement($("#editNodeSharingButton"),
null!=e&&!meta64.isAnonUser);util.setEnablement($("#moveSelNodesButton"),null!=e&&!meta64.isAnonUser);util.setEnablement($("#renameNodePgButton"),null!=e&&!meta64.isAnonUser);util.setEnablement($("#finishMovingSelNodesButton"),f,f);util.setEnablement($("#openExportPgButton"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#openImportPgButton"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#deleteSelNodesButton"),a)}};console.log("Module ready: popupMenuPg.js");return b}();console.log("running module: prefsPg.js");
...
c=render.makeBackButton("Cancel","cancelPreferencesPgButton","a"),b=render.makeHorzControlGroup(b+c),c=render.makeButton("Close Account","closeAccountButton","a"),c=render.makeHorzControlGroup(c),a=render.makeTag("div",{"class":"ui-field-contain"},a+b+c),a=render.makeTag("div",{role:"main","class":"ui-content dialog-content"},""+a),d=d+a;util.setHtmlEnhanced($("#prefsPg"),d);$("#savePreferencesButton").on("click",prefs.savePreferences);$("#closeAccountButton").on("click",prefs.closeAccount)}}}();console.log("running module: renameNodePg.js");
...
c,"data-rel":"back"},a)},allowPropertyToDisplay:function(a){return null==meta64.simpleModePropertyBlackList[a]},isReadOnlyProperty:function(a){return meta64.readOnlyPropertyList[a]},isBinaryProperty:function(a){return meta64.binaryPropertyList[a]},sanitizePropertyName:function(a){return"simple"===meta64.editModeOption?a===jcrCnst.CONTENT?"Content":a:a}};console.log("Module ready: render.js");return d}();console.log("running module: search.js");
