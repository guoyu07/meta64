...
a.callback&&a.callback()},inSimpleMode:function(){return a.editModeOption===a.MODE_SIMPLE},goToMainPage:function(b,c){a.jqueryChangePage("mainTabName");c&&(a.treeDirty=!0);b||a.treeDirty?(a.treeDirty?view.refreshTree(null,!0):render.renderPageFromData(),a.refreshAllGuiEnablement()):view.scrollToSelectedNode()},jqueryChangePage:function(a){document.querySelector("#mainIronPages").select(a)},changePage:function(b,c){if("undefined"===typeof b.tabId)return console.log("oops, wrong object type passed to changePage function."),
...
a=!0,d||(d=!0,messagePg.alert("Session timed out. Page will refresh.")),$(window).off("beforeunload"),window.location.href=window.location.origin;else{var e="Server request failed.\n\n";try{e+="Status: "+l.statusText+"\n",e+="Code: "+l.status+"\n"}catch(c){}messagePg.alert(e)}});return l}},ajaxReady:function(a){return 0<b?(console.log("Ignoring requests: "+a+". Ajax currently in progress."),!1):!0},isAjaxWaiting:function(){return 0<b},delayedFocus:function(a){setTimeout(function(){$(a).focus()},1E3)},
checkSuccess:function(a,b){b.success||messagePg.alert(a+" failed: "+b.message);return b.success},addAll:function(a,b){for(var c=0;c<b.length;c++)b[c]?a[b[c]]=!0:console.error("null element in addAll at idx="+c)},nullOrUndef:function(a){return null===a||void 0===a},getUidForId:function(a,b){var c=a[b];c||(c=meta64.nextUid++,a[b]=c);return c},elementExists:function(a){a.startsWith("#")&&(a=a.substring(1));return a.contains("#")?(console.log("Invalid # in domElm"),null):null!=document.getElementById(a)},
getTextAreaValById:function(a){return c.domElm(a).value},domElm:function(a){a.startsWith("#")&&(a=a.substring(1));if(a.contains("#"))return console.log("Invalid # in domElm"),null;var b=document.getElementById(a);b&&0!=b.length||console.log("domElm Error. Required element id not found: "+a);return b},polyElm:function(a){a.startsWith("#")&&(a=a.substring(1));if(a.contains("#"))return console.log("Invalid # in domElm"),null;var b=document.getElementById(a);b&&0!=b.length||console.log("domElm Error. Required element id not found: "+
a);return Polymer.dom(b)},getRequiredElement:function(a){var b=$(a);null==b&&console.log("getRequiredElement. Required element id not found: "+a);return b},setCheckboxVal:function(a,b){$(a).prop("checked",b).checkboxradio("refresh")},isObject:function(a){return a&&0!=a.length},currentTimeMillis:function(){return(new Date).getMilliseconds()},emptyString:function(a){return!a||0==a.length},getInputVal:function(a){return c.polyElm(a).node.value},hookSlider:function(a,b){c.getRequiredElement(a).change(b);
...
util.setHtmlEnhanced(d.domId+"-"+a.guid,b)},init:function(a){$("#confirmPgTitle-"+a.guid).text(a.title);$("#confirmPgMessage-"+a.guid).text(a.message);$("#confirmPgYesButton-"+a.guid).text(a.buttonText)}};console.log("Module ready: confirmPg.js");return d}();console.log("running module: popupMenuPg.js");
var popupMenuPg=function(){function d(a,b){return render.tag("paper-submenu",{},"<paper-item class='menu-trigger'>"+a+"</paper-item>"+render.tag("paper-menu",{"class":"menu-content my-menu-section",multi:"multi"},b,!0),!0)}function a(a,b,d){return render.tag("paper-item",{id:b,onclick:d},a,!0)}var b={domId:"mainNavBar",build:function(){var c=a("Change Password","changePasswordPgButton","user.changePasswordPg();")+a("Preferences","accountPreferencesPgButton","prefs.accountPreferencesPg();")+a("Insert Book: War and Peace",
"insertBookWarAndPeaceButton"," edit.insertBookWarAndPeace();")+a("Donate","donatePgButton","donatePg.open();"),c=d("My Account",c),e=a("Attachments","manageAttachmentsButton","attachment.openUploadPg();")+a("Move","moveSelNodesButton","edit.moveSelNodes();")+a("Finish Moving","finishMovingSelNodesButton","edit.finishMovingSelNodes();")+a("Rename","renameNodePgButton","edit.openRenameNodePg();")+a("Delete","deleteSelNodesButton","edit.deleteSelNodes();")+a("Clear Selections","clearSelectionsButton",
"edit.clearSelections();"),e=d("Edit",e),f=a("Edit Node Sharing","editNodeSharingButton","share.editNodeSharing();")+a("Find Shared Subnodes","findSharedNodesButton","share.findSharedNodes();"),f=d("Sharing",f),g=a("Text Search","searchPgButton","srch.searchPg();")+a("Timeline","timelineButton","srch.timeline();"),g=d("Search",g),h=render.tag("paper-item",{id:"propsToggleButton",onclick:"props.propsToggle();"},"Toggle Properties",!0)+a("Refresh","refreshPageButton","meta64.goToMainPage(true,true);")+
a("Show URL","showFullNodeUrlButton","render.showNodeUrl();")+a("Server Info","showServerInfoButton","view.showServerInfo();"),h=d("View Options",h);util.setHtmlEnhanced(b.domId,c+e+f+h+g)},init:function(){meta64.refreshAllGuiEnablement()}};console.log("Module ready: popupMenuPg.js");return b}();console.log("running module: donatePg.js");var donatePg=function(){var d={domId:"donatePg",tabId:"popup",open:function(){var a={};meta64.registerDataObject(a);meta64.changePage(donatePg,a)},build:function(a){var b;b="<donate-panel></donate-panel>"+render.centeredButtonBar(render.makePopupBackButton("Close","donatePgCloseButton-"+a.guid,d.domId));console.log("fields="+b);util.setHtmlEnhanced(d.domId+"-"+a.guid,b)},init:function(a){}};console.log("Module ready: donatePg.js");return d}();console.log("running module: editPropertyPg.js");
...
a+(b+c+"<div><h3>-- OR --</h3>Enter URL to a file on the web...</div>"+e+f))},init:function(){$("#uploadFromUrl").val("");$("#uploadPathDisplay").html("Path: "+render.formatPath(attachment.uploadNode))}};console.log("Module ready: uploadPg.js");return d}();console.log("running module: shareToPersonPg.js");
...
a+(b+c));util.bindEnterKey("#userName",user.login);util.bindEnterKey("#password",user.login)},init:function(){user.populateLoginPgFromCookies()}};console.log("Module ready: loginPg.js");return d}();console.log("running module: changePasswordPg.js");
var changePasswordPg=function(){var d={domId:"changePasswordPg",tabId:"dialogsTabName",visible:!1,build:function(){var a=render.makeDialogHeader("Change Password"),b=render.makePasswordField("Password","changePassword1")+render.makePasswordField("Repeat Password","changePassword2"),c=render.makeButton("Change Password","changePasswordActionButton","user.changePassword();"),e=render.makeBackButton("Close","cancelChangePasswordButton",d.domId),c=render.centeredButtonBar(c+e);util.setHtmlEnhanced(d.domId,
a+b+c)},init:function(){util.delayedFocus("#changePassword1")}};console.log("Module ready: changePasswordPg.js");return d}();console.log("running module: editNodePg.js");
...
"-"+a.guid,b)},init:function(a){a.title&&$("#messagePgTitle-"+a.guid).text(a.title);$("#messagePgMessage-"+a.guid).html(a.message)}};console.log("Module ready: messagePg.js");return d}();console.log("running module: searchPg.js");
...
c.name+" count="+c.values.length);var g="",h=c.values;h&&0!=h.length||(h=[],h.push(""));for(var l=0;l<h.length;l++){console.log("prop multi-val["+l+"]="+h[l]);var m=a+"_subProp"+l,n=f?"[binary]":h[l],p=n?n:"",p=n.escapeForAttrib(),n=(0==l?c.name:"*")+"."+l,g=f||d?g+render.tag("paper-textarea",{id:m,readonly:"readonly",disabled:"disabled",label:n,value:p},"",!0):g+render.tag("paper-textarea",{id:m,label:n,value:p},"",!0)}return g},makeSinglePropEditor:function(a,c,d,f){console.log("Property single-type: "+
...
null,view.refreshTree(null,!1))},m=function(a){util.checkSuccess("Change node position",a)&&meta64.goToMainPage(!0,!0)},n=function(a){util.checkSuccess("Insert node",a)&&(meta64.initNode(a.newNode),meta64.highlightNode(a.newNode,!0),k.runEditNode(a.newNode.uid))},p=function(a){util.checkSuccess("Make node referencable",a)&&messagePg.alert("This node is now referencable, and can be accessed by unique ID");view.refreshTree(null,!1)},q=function(a){util.checkSuccess("Split content",a)&&(view.refreshTree(null,
!1),meta64.jqueryChangePage("mainTabName"),view.scrollToSelectedNode())},r=function(a){util.checkSuccess("Create subnode",a)&&(meta64.initNode(a.newNode),k.runEditNode(a.newNode.uid))},k={nodesToMove:null,editingUnsavedNode:!1,editNode:null,nodeInsertTarget:null,startEditingNewNode:function(){k.editingUnsavedNode=!1;k.editNode=null;k.saveNewNode("")},startEditingNewNodeWithName:function(){k.editingUnsavedNode=!0;k.editNode=null;meta64.changePage(editNodePg)},editMode:function(){meta64.editMode=meta64.editMode?
!1:!0;var a=$("#editModeButton");a.toggleClass("ui-icon-edit",meta64.editMode);a.toggleClass("ui-icon-forbidden",!meta64.editMode);render.renderPageFromData();view.scrollToSelectedNode()},makeNodeReferencable:function(){util.json("makeNodeReferencable",{nodeId:k.editNode.id},p)},splitContent:function(){var a=k.getNodeBelow(k.editNode);util.json("splitNode",{nodeId:k.editNode.id,nodeBelowId:null==a?null:a.id},q)},cancelEdit:function(){meta64.treeDirty?meta64.goToMainPage(!0):(meta64.jqueryChangePage("mainTabName"),
view.scrollToSelectedNode())},saveNode:function(){k.editingUnsavedNode?k.saveNewNode():k.saveExistingNode()},saveNewNode:function(b){b||(b=util.getInputVal("newNodeNameId"));meta64.userName!=d.createdBy&&"admin"!=d.createdBy&&(a=!0);meta64.treeDirty=!0;k.nodeInsertTarget?util.json("insertNode",{parentId:d.id,targetName:k.nodeInsertTarget.name,newNodeName:b},n):util.json("createSubNode",{nodeId:d.id,newNodeName:b},r)},saveExistingNode:function(){for(var c=[],d=0,e=0;;){var f="editNodeTextContent"+
d;if(meta64.fieldIdToPropMap.hasOwnProperty(f)){if(util.elementExists(f)){var g=meta64.fieldIdToPropMap[f],f=util.getTextAreaValById(f);f!==g.value&&(c.push({name:g.name,value:f}),e++)}}else break;d++}0<e?(util.json("saveNode",{nodeId:k.editNode.id,properties:c,sendNotification:a},b),a=!1):messagePg.alert("You didn't change any information!")},moveNodeUp:function(a){var b=meta64.uidToNodeMap[a];b?(a=k.getNodeAbove(b),null!=a&&util.json("setNodePosition",{parentNodeId:meta64.currentNodeId,nodeId:b.name,
...
meta64.currentNodeId,d=util.json("renameNode",{nodeId:b.id,newName:a});d.completes.then(function(){var a=d.response;util.checkSuccess("Rename node",a)&&(c?view.refreshTree(a.newId,!0):view.refreshTree(null,!1,a.newId),meta64.jqueryChangePage("mainTabName"))})}else messagePg.alert("Select a node to rename.")}},exportNodes:function(){var a=meta64.getHighlightedNode(),b=util.getInputVal("exportTargetNodeName");util.emptyString(b)?messagePg.alert("Please enter a name for the export file."):a&&util.json("exportToXml",
...
a))},populateEditNodePg:function(){view.initEditPathDisplayById("#editNodePathDisplay");var a="",b=0;meta64.fieldIdToPropMap={};if(k.editNode)$.each(k.editNode.properties,function(c,d){if(render.allowPropertyToDisplay(d.name)){var e="editNodeTextContent"+b;meta64.fieldIdToPropMap[e]=d;var f=d.values&&0<d.values.length,g=render.isReadOnlyProperty(d.name),h=render.isBinaryProperty(d.name);if(g||h)e="RdOnly_"+e;var l="";g||h||(l=k.makePropertyEditButtonBar(d,e));l=f?l+props.makeMultiPropEditor(e,d,g,
h):l+props.makeSinglePropEditor(e,d,g,h);a+=render.tag("div",{"class":"genericListItem"},l);b++}else console.log("Hiding property: "+d.name)});else var c=render.tag("paper-textarea",{id:"newNodeNameId",label:"New Node Name"},"",!0),a=a+render.tag("div",{},c);util.setHtmlEnhanced("propertyEditFieldContainer",a);c=k.editingUnsavedNode?"You may leave this field blank and a unique ID will be assigned. You only need to provide a name if you want this node to have a more meaningful URL.":"";$("#editNodeInstructions").html(c);
util.setVisibility("#addPropertyButton",!k.editingUnsavedNode);c=k.editNode&&k.editNode.id&&!k.editNode.id.startsWith("/");util.setVisibility("#makeNodeReferencableButton",k.editNode&&!c&&!k.editingUnsavedNode)},makePropertyEditButtonBar:function(a,b){var c="",c=render.tag("paper-button",{raised:"raised",onClick:"props.clearProperty('"+b+"');"},"Clear"),d="",e="";a.name!==jcrCnst.CONTENT&&(e=render.tag("paper-button",{raised:"raised",onClick:"props.deleteProperty('"+a.name+"');"},"Del"),d=render.tag("paper-button",
{raised:"raised",onClick:"props.addSubProperty('"+b+"');"},"Add Multi"));c=d+c+e;return c=0<c.length?render.makeHorizontalFieldSet(c,"property-edit-button-bar"):""},insertNode:function(a){if(d=meta64.currentNode){var b=null;if(b=a?meta64.uidToNodeMap[a]:meta64.getHighlightedNode())k.nodeInsertTarget=b,k.startEditingNewNode()}else console.log("Unknown parent")},createSubNodeUnderHighlight:function(){(d=meta64.getHighlightedNode())?(k.nodeInsertTarget=null,k.startEditingNewNode()):messagePg.alert("Tap a node to insert under.")},
replyToComment:function(a){k.createSubNode(a)},createSubNode:function(a){if(a){if(d=meta64.uidToNodeMap[a],!d){console.log("Unknown nodeId in createSubNode: "+a);return}}else d=meta64.currentNode;k.nodeInsertTarget=null;k.startEditingNewNode()},clearSelections:function(){meta64.clearSelectedNodes();render.renderPageFromData();meta64.jqueryChangePage("mainTabName")},deleteSelNodes:function(){var a=meta64.getSelectedNodeIdsArray();a&&0!=a.length?confirmPg.areYouSure("Confirm Delete","Delete "+a.length+
" node(s) ?","Yes, delete.",function(){util.json("deleteNodes",{nodeIds:a},g)}):messagePg.alert("You have not selected any nodes. Select nodes to delete first.")},moveSelNodes:function(){var a=meta64.getSelectedNodeIdsArray();a&&0!=a.length?confirmPg.areYouSure("Confirm Move","Move "+a.length+" node(s) to a new location ?","Yes, move.",function(){k.nodesToMove=a;meta64.selectedNodes={};messagePg.alert("Ok, ready to move nodes. To finish moving, go select the target location, then click 'Finish Moving'");
meta64.refreshAllGuiEnablement()}):messagePg.alert("You have not selected any nodes. Select nodes to move first.")},finishMovingSelNodes:function(){confirmPg.areYouSure("Confirm Move","Move "+k.nodesToMove.length+" node(s) to selected location ?","Yes, move.",function(){var a=meta64.getHighlightedNode();util.json("moveNodes",{targetNodeId:a.id,targetChildId:null!=a?a.id:null,nodeIds:k.nodesToMove},l)})},insertBookWarAndPeace:function(){confirmPg.areYouSure("Confirm","Insert book War and Peace?","Yes, insert book.",
function(){var a=meta64.getHighlightedNode();a?util.json("insertBook",{nodeId:a.id,bookName:"War and Peace"},f):messagePg.alert("No node is selected.")})}};console.log("Module ready: edit.js");return k}();console.log("running module: view.js");
...
meta64.highlightRowById(c,!0):a.scrollToSelectedNode();meta64.refreshAllGuiEnablement()},refreshTree:function(b,c,d){b||(b=meta64.currentNodeId);console.log("Refreshing tree: nodeId="+b);var f=util.json("renderNode",{nodeId:b,renderParentIfLeaf:c?!0:!1});f.completes.then(function(){a.refreshTreeResponse(f.response,b,c,d)})},scrollToSelectedNode:function(){d=!0;setTimeout(function(){d=!1;var a=nav.getSelectedPolyElement();a?a.node.scrollIntoView():(a=util.polyElm("mainPaperTabs"))&&a.node.scrollIntoView()},
1E3)},scrollToTop:function(){d||setTimeout(function(){if(!d){var a=util.polyElm("mainPaperTabs");a&&a.node.scrollIntoView()}},1E3)},initEditPathDisplayById:function(a){var c=edit.editNode;a=$(a);if(edit.editingUnsavedNode)a.html(""),a.hide();else{var d="Path: "+render.formatPath(c),d=d+("<br>ID: "+c.id);c.lastModified&&(d+="<br>Modified: "+c.lastModified);a.html(d);a.show()}},showServerInfo:function(){var a=util.json("getServerInfo",{});a.completes.then(function(){messagePg.showMessage("Server Info",
a.response.serverInfo,null)})}};console.log("Module ready: view.js");return a}();console.log("running module: attachment.js");
