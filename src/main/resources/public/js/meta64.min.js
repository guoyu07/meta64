...
var srch=function(){var d={searchResults:null,highlightRowNode:null,identToUidMap:{},uidToNodeMap:{},numSearchResults:function(){return null!=srch.searchResults&&null!=srch.searchResults.searchResults&&null!=srch.searchResults.searchResults.length?srch.searchResults.searchResults.length:0},searchNodesResponse:function(a){d.searchResults=a;meta64.changePage(searchResultsPg)},searchNodes:function(){if(util.ajaxReady("searchNodes")){var a=meta64.getHighlightedNode();if(a){var b=$.trim($("#searchText").val());
util.emptyString(b)?alert("Enter search text."):util.json("nodeSearch",{nodeId:a.id,searchText:b,modSortDesc:!1},d.searchNodesResponse)}else alert("No node is selected to search under.")}},timeline:function(){var a=meta64.getHighlightedNode();a?util.json("nodeSearch",{nodeId:a.id,searchText:"",modSortDesc:!0},d.searchNodesResponse):alert("No node is selected to search under.")},searchPg:function(){meta64.changePage(searchPg)},initSearchNode:function(a){a.uid=util.getUidForId(d.identToUidMap,a.id);
d.uidToNodeMap[a.uid]=a},populateSearchResultsPage:function(a){a||(a=d.searchResults);var b="",c=a.searchResults.length,e=0;$.each(a.searchResults,function(a,g){meta64.isNodeBlackListed(g)||(d.initSearchNode(g),e++,b+=d.renderSearchResultAsListItem(g,a,c,e))});util.setHtmlEnhanced($("#searchResultsView"),b)},renderSearchResultAsListItem:function(a,b,c,e){b=a.uid;a.name.startsWith("rep:")||meta64.currentNodeData.node.path.contains("/rep:");return render.makeTag("div",{"class":"node-table-row inactive-row",
onClick:"srch.clickOnSearchResultRow(this, '"+b+"');",id:b+"_srch_row"},d.makeButtonBarHtml(b)+render.makeTag("div",{id:b+"_srch_content"},render.renderNodeContent(a,!0,!0,!0)))},makeButtonBarHtml:function(a){a=render.makeTag("a",{onClick:"srch.clickSearchNode('"+a+"');","class":"ui-btn ui-mini ui-btn-b ui-btn-inline ui-icon-carat-l ui-btn-icon-left"},"Go to Node");return render.makeHorizontalFieldSet(a,"compact-field-contain")},clickOnSearchResultRow:function(a,b){d.unhighlightRow();d.highlightRowNode=
d.uidToNodeMap[b];util.changeOrAddClass(a,"inactive-row","active-row")},clickSearchNode:function(a){srch.highlightRowNode=srch.uidToNodeMap[a];view.refreshTree(srch.highlightRowNode.id,!0);meta64.jqueryChangePage("#mainPage")},unhighlightRow:function(){if(d.highlightRowNode){var a=util.domElm(d.highlightRowNode.uid+"_srch_row");a&&util.changeOrAddClass(a,"active-row","inactive-row")}}};console.log("Module ready: search.js");return d}();console.log("running module: user.js");
