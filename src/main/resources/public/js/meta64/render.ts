...
var render = function() {
    ...
    var _ = {
        ...
        renderNodeContent: function(node, showPath, showName, renderBinary, rowStyling, showHeader) {
            var ret: string = _.getTopRightImageTag(node);
        ...
        centeredButtonBar: function(buttons?: any, classes?: any) {
            classes = classes || "";
        ...
        makeHorizontalFieldSet: function(content?: string, extraClasses?: string) {
		 ...
		 */
        renderPageFromData: function(data?: any) {
		 ...
		 * content is non-null
		 */
        tag: function(tag?: any, attributes?: any, content?: any, closeTag?: any) {
        ...
        sanitizePropertyName: function(propName: any) {
