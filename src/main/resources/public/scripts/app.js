(function(document) {
	...
	app.baseUrl = '/';
	app.claysVal = "Clays Test;"
	
	if (window.location.port === '') { // if production
		// Uncomment app.baseURL below and
		// set app.baseURL to '/your-pathname/' if running from folder in
		// production
...
//		//todo: id document working here instead of this.root ?
...
//		// appName max size when condensed. The smaller the number the smaller
//		// the condensed size.
