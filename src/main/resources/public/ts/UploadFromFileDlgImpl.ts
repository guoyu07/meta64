...
export default class UploadFromFileDlgImpl extends DialogBaseImpl implements UploadFromFileDlg {
    ...
    //commenting out entire implementation becasue DialogBaseImpl got refactored and it's not worth
    //updating this 'dead' code, unless I ever need to 'revive' it some day. I guess soon, i'll just take it
    //out and put it in the 'attic' subfolder.
    // /*
