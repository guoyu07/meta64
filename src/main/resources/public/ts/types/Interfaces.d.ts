...
export declare class AdSegment {
    beginTime: number;
    endTime: number;
    constructor(beginTime: number, endTime: number);
}
export declare class PropEntry {
    id: string;
    checkboxId: string;
    ...
    binary: boolean;
    subProps: SubProp[];
    constructor(id: string, checkboxId: string, property: PropertyInfo, readOnly: boolean, binary: boolean, subProps: SubProp[]);
}
export declare class SubProp {
    id: string;
    val: string;
