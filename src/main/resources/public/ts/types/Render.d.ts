...
export declare class Render {
    ...
    private PRETTY_TAGS;
    private debug;
    private getEmptyPagePrompt;
    private renderBinary;
    buidPage: (pg: any, data: any) => void;
    ...
    renderNodeContent: (node: I.NodeInfo, showPath: any, showName: any, renderBin: any, rowStyling: any, showHeader: any) => string;
    ...
    makeImageTag_original: (node: I.NodeInfo) => string;
